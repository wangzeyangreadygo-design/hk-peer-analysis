...
## Handling 招商永隆 figures

These terms refer to the user's own bank:
- 招商永隆 / 永隆 / CMB Wing Lung
- 我行 / 本行

**Rule:** use real figures the user supplied (chat, attached file, earlier turn, or internal data). When no real figure is available, leave `{{待填}}` for the strategy team to fill.

Example — user supplied real data:
> 恒生零售非息同比增长 37%，永隆零售非息同比增长 6.2%

Example — user did not supply figures:
> 恒生零售非息同比增长 37%，永隆零售非息同比增长 {{待填}}
